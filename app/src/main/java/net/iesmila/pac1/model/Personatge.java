...
public class Personatge implements Serializable {
    ...
    public static List<Personatge> getPersonatges() {
        if (mPersonatges == null) {
            ...
            mPersonatges.add(new Personatge("Orco", Rasa.getRasaPerCodi(1, Alignment.HORDE), Sexe.FEMALE, Ofici.getOficiPerCodi(1), R.drawable.orc, 10, 40, 30, 40, 20, 10, ""));
    ...
    public Personatge() {
        mRasa = Rasa.getRasaPerCodi(1, Alignment.ALLIANCE);
        mSexe = Sexe.MALE;
        mOfici = Ofici.getOficiPerCodi(1);
    }
